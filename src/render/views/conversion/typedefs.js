 ...
 * @prop {string} [image] Source of an image to render before the title. It'll
 * be small like a logo/symbol.
 *
 * For characters like emoji, add them directly to the `title` or `subtitle`
 */
 ...
 *
 * To control the order of the all units without grouping them,
 * pass one {@link UnitGroup} without a `name` property.
 *
 * @prop {{[unitID in U['id']]: UnitConversionTemplate}} [unitTemplates] Define how each 
 * unit should be rendered. If omitted, untis are rendered by default as:
 *
